...
function ($,clientInfo,widget,fastclick,util,userCenterApi) {
    ...
    RecommenduserlistDo.prototype.render=function(){
    ...
    RecommenduserlistDo.prototype.userEvents=function(){
    ...
    RecommenduserlistDo.prototype.loadData=function(){
        var t=this;
        var url=t.host+'/api/v1/client/ucenter/invite-user';
                ...
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        if(!!data && !!data.list && data.list.length>0){
                            ...
                            try{
                                var newsHtml = util.compileTempl("recommendUserList", data);   
                            }catch(e){
                                widget.loadState();
                                return;
                            }
                            $('.recommend-userlist').append(newsHtml);  
                            t.page++;
    ...
    RecommenduserlistDo.prototype.init=function(){
        var t=this; 
    ...
    return new RecommenduserlistDo();
});